...
| H38 | Ecke beim Zusammenfügen | ✅ | fehlt der Bogen der Achse (dort sitzt kein Maximum der Breite), wird der Schnittpunkt der beiden Schenkel eingesetzt statt einer Sehne quer durch die Ecke – nur, wenn der Umweg klein bleibt (≤ 2,8 × Lücke). An Ecken gilt „kein Rückwärtsgang“ nicht; liegt der Schnitt knapp außerhalb, wird er zurückgezogen |
| H39 | Rahmen 100 × 60 mm, Steg 5 mm | ✅ | **1 geschlossener Zug, 294,9 mm**; theoretisch 297,6 mm (−0,9 %, die Achse läuft an den Ecken auf Parabeln, Ecke bei 2,93 / 2,93) |
| H40 | Kreisring r = 8 / 7,6 mm | ✅ | 48,9 mm gegen 2 π × 7,8 = 49,01 mm – auf 0,2 ‰ genau |
